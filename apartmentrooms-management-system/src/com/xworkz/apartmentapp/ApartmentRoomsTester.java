...
public class ApartmentRoomsTester {
	...
	public static void main(String[] args) {
		...
		for(int i = 0; i < size; i++) {
			...
			//int roomNo1 = scan.nextInt();
			//System.out.println("ENTER ROOM BHK");
			//int bhk1 = scan.nextInt();
			//System.out.println("ENTER ROOM OWNER NAME");
			//String ownerName1 = scan.next();
			//System.out.println("ENTER ROOM OWNER CONTACT NO");
			//long ownerContactNo1 = scan.nextLong();
		...
		System.out.println("enter 5 to get room details by room bhk");
		...
		case 5: System.out.println("enter the room bhk");
		int bhk = scan.nextInt();
		apart1.getRoomByBhk(bhk);
		break;
